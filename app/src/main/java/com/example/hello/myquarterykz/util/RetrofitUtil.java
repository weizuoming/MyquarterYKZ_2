...
public class RetrofitUtil {
    ...
    public static RetrofitUtil getFlice(String baseurl){
    ...
    public static ApiService setService(){
        ...
        return RetrofitUtil.getFlice(ApiUrl.BASE_URL).getCreateService(ApiService.class);
    }
    /**
     * 公共参数的拦截器
     */
    private static class CommonParamsInterceptor implements Interceptor {
        ...
        public Response intercept(Chain chain) throws IOException {
            ...
            if (namepwd != null) {
                String token = namepwd.getString("token", "");
                map.put("token", token);
